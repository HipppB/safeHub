...
Lexer.prototype.lex = function () {
  ...
  if (!this.all_tokens) {
    ...
    // ignore white space
    !this.comment_tokens && (token === this.tok.T_COMMENT ||
...
[__webpack_require__(7010), __webpack_require__(438), __webpack_require__(3607), __webpack_require__(7405), __webpack_require__(465), __webpack_require__(5135), __webpack_require__(4437), __webpack_require__(1298), __webpack_require__(5609)].forEach(function (ext) {
  for (var k in ext) {
...
Parser.prototype.lex = function () {
  ...
  if (this.extractTokens) {
    ...
    // ignore white space
    !this.extractDoc && (this.token === this.tok.T_COMMENT ||
    // ignore single lines comments
  ...
  read_class_body: function read_class_body(allow_variables, allow_enum_cases) {
    ...
    while (this.token !== this.EOF && this.token !== "}") {
      ...
      if (this.token === this.tok.T_FUNCTION) {
        ...
        attrs = [];
      } else if (allow_variables && (this.token === this.tok.T_VARIABLE || this.version >= 801 && this.token === this.tok.T_READ_ONLY ||
      ...
      case this.tok.T_CONSTANT_ENCAPSED_STRING:
        {
          ...
          value = value(isDoubleQuote, textValue, offset === 1,
          // unicode flag
          text);
          if (this.token === this.tok.T_DOUBLE_COLON) {
...
var tokens = {
  values: Object.entries(TokenNames).reduce(function (result, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      key = _ref2[0],
      value = _ref2[1];
    return _defineProperty({}, value, key);
  }, {}),
  names: TokenNames
};
